...
def main():
    ...
    with torch.no_grad():
        ...
        new_conv_in.weight[:, : unet.conv_in.weight.shape[1], :, :].copy_(unet.conv_in.weight)
    ...
    if args.dataset_name is not None and os.path.isdir(args.dataset_name):
        # save_to_disk したローカルデータセットを読む
